...
const Interview = () => {
    ...
    const scoreColor =
        reportData.matchScore >= 80 ? 'score--high' :
            reportData.matchScore >= 60 ? 'score--mid' : 'score--low'

    const matchSubText =
        reportData.matchScore >= 80 ? 'Strong match for this role' :
            reportData.matchScore >= 60 ? 'Good match for this role' : 'Needs improvement'
            ...
            <div className='interview-layout'>
                ...
                <aside className='interview-sidebar'>
                    ...
                    <div className='match-score'>
                        ...
                        <p className='match-score__sub'>{matchSubText}</p>
                    </div>
